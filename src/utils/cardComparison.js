...
const { Suits, Ranks, Combinations } = require("../constants");

function compareHighest(cards1, cards2) {
  /*
...
function validCombination(cards) {
  /*
  ...
  */
  ...
  if (cards.length >= 3 && cards.every((card) => card.rank !== "2")) {
    // straight
...
function validChop(center, cards) {
...
module.exports = { compareCards, validCombination, validChop, compareHighest };
